...
\label{sec:proposal}
	...
	% Recall the Necessity of better development environment for LWs
	...
	%
	% Recall the restritive caracteristics of LWs
...
\label{sec:lwbmpi-sendrecv}
	...
	\begin{figure}[t]
		\centering
		\includegraphics[width=0.6\linewidth]{send-recv_protocol}
